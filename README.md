...
Thank You
---
Spring Boot, H2, Thymeleaf, PostMan, Test Code 작성 등 새로 알게 되어 사용해본 것들이 많았습니다. 이들 모두 전에 사용하던 도구 또는 방법을 개선시킬 수 있는 것들이었고, 그 효율과 편리가 참 인상 깊습니다. 후에 더 적절한 구성을 하기 위한 선택지가 늘어나게 된 것에 기쁘고, 또한 과제로써 이번 기회를 제공해주신 Alethio의 인사 담당자에게도 감사를 남깁니다.
